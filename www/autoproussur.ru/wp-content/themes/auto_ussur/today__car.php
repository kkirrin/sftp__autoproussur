...
<main>
    ...
    <section class="pt-12 md:pt-14 cars">
        <div class="container relative">
            ...
            <?php
                    ...
                    ?>
                        ...
                        <?php echo get_field('sale') ? '<span style="width: max-content; top: 10px; left: 250px;" class="absolute bg-red py-2 px-4 rounded-3xl text-white">' . get_field('sale') . ' %</span>' : ''; ?>
