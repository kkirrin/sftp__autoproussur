                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex justify-between items-center gap-10">
                        <div class="flex items-center justify-between gap-2">
                            <a href="/" class="flex items-center justify-between gap-2">
                                <img src="/logo.png" alt="логотип в шапке">     
                            </a>
                        </div>
        
                        <div> 
                            <ul class="mobile gap-2 flex-wrap text-main-black hidden md:flex items-center justify-center mobile__menu__style">
                                <li class="transform hover:scale-105 transition-all mr-4  "><a class="text-black font-semibold" href="/catalog.html">Каталог</a></li>
                                <li class="transform hover:scale-105 transition-all mr-4  "><a class="text-black font-semibold" href="/about.html">О компании</a></li>
                                <li class="transform hover:scale-105 transition-all mr-4  "><a class="text-black font-semibold" href="/review.html">Отзывы</a></li>
                                <li class="transform hover:scale-105 transition-all mr-4  "><a class="text-black font-semibold" href="/contact.html">Контакты</a></li>
                                <li class="transform hover:scale-105 transition-all mr-4  "><a class="text-black font-semibold" href="/">Договор</a></li>
                    ...
                    <div class="flex md:hidden items-center justify-between gap-2">
                        <a href="/" class="flex md:hidden items-center justify-between gap-2">
                            <img src="/logo.png" class="" alt="логотип в шапке">
                        </a>
                    </div>
                    ...
                    <div class="flex md:hidden items-center">
                        ...
                        <li class="flex xs:flex sm:flex md:hidden sm:list-none">
                            <a href="https://www.instagram.com/geometry_nhk/">
                                <img class="transform hover:scale-105 transition-all p-2" src="src/img/icons/tg.svg" alt="" >
                            </a>
                        </li>
        
                        <li class="flex xs:flex sm:flex md:hidden">
                            <a class="nav-link" href="https://api.whatsapp.com/send/?phone=79510154751">
                            <img class="transform hover:scale-105 transition-all p-2" src="src/img/icons/sap.svg" alt="" >
                            </a>
                        </li>
                                ...
                                ?> -->
                                    ...
                                    <ul class="flex justify-start padding__bottom__link pt-7">
                                        <li class="mr-2 list-none pt-2 pb-5 gap-2">
                                            <a href="https://api.whatsapp.com/send/?phone=79510154751">
                                                <img class="" src="src/img/icons/sap__white.svg" alt="" >
                                            </a>
                                        </li>
                                        <li class="mr-2 list-none pt-2 pb-5 gap-2">
                                            <a href="https://www.instagram.com/geometry_nhk/">
                                                <img class="" src="src/img/icons/tg__white1.svg" alt="" >
                                            </a>
                                        </li>
                                        
                                        <li class="mr-4 list-none pt-2 pb-5 gap-2 padding__bottom__link">
                                            <a href="https://api.whatsapp.com/send/?phone=79532109127">
                                                <img class="" src="src/img/icons/youtube_white.svg" alt="" >
                                            </a>
                                        </li>
                                    </ul>  
                            </nav>                
