...
<main>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide relative -z-10">
                        ...
                        <div class="w-full md:w-1/3 relative rounded-2xl overflow-hidden h-[63vh] md:h-[auto]">
                            ...
                            <img class="scale-[.8] sm:scale-[1.2] md:scale-90 absolute img__red -z-10" src="<?php echo get_template_directory_uri() . '/src/img/main/circle__right.png'; ?>" alt="">
                            <img class="absolute bottom-0.5 left-0 -z-20 img__black" src="<?php echo get_template_directory_uri() . '/src/img/main/circle__left.png'; ?>" alt="">
                            <img class="scale-[.8] sm:scale-[1.2] md:scale-90 absolute img__car z-10" src="<?php echo get_template_directory_uri() . '/src/img/main/circle__car.png'; ?>" alt="">
                        </div>
    ...
    <!-- Фильтрация -->
    <section class="pt-12 md:pt-24 filter-swiper filter">
                        ...
                        <?php
                           ...
                           $my_posts = get_posts(array(
                            ...
                            foreach ($my_posts as $post) : 
                                ...
                                $firstPhoto = reset($photos);
                            ?>
                                <div id='test' class="swiper-slide flex flex-col w-[310px] relative">
   ...
   <!-- Популярные автомобили -->
    ...
    <section class="relative pt-20 z-0 pb-40 p-2">
        <div class="container bg-red px-5 md:py-16 py-0 md:px-28 rounded-3xl relative" style="height: 420px;">
            ...
            <h2 class="text-white text-center md:text-start md:text-4xl text-xl uppercase pt-60 md:pt-4 pb-6 z-10" style="font-weight: 600;">
